...
export const renderRecipe = recipe => {
   const html = `
                    ...
                    <div class="recipe__info">
                        ...
                        <span class="recipe__info-data recipe__info-data--people">${recipe.HumanNumber}</span>
                    ...
                    <ul class="recipe__ingredient-list">
                        ${recipe.ingredients.map(el=>renderNairlag(el)).join(' ')}    
                    </ul>
                ...
                <div class="recipe__directions">
                    ...
                    <p class="recipe__directions-text">
                        ...
                        <span class="recipe__by">The Pioneer Woman</span>. Манай вэб сайтаас жорын зааврыг авна уу
                    </p>
